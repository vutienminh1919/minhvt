    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="submitCreateUser" style="display: none">Xác nhận</button>
                <button type="button" class="btn btn-primary" id="submitUpdateUser" style="display: none">Xác nhận</button>
            </div>
        </div>
    </div>
</div>
